...
export default function AdminPage() {
  ...
  useEffect(() => { if (window.location.search.includes('all=1')) setShowAllTracks(true); const saved = window.localStorage.getItem('phumtify-site-name'); if (saved) { setSiteName(saved); setSavedName(saved); } loadTracks(); }, []);
