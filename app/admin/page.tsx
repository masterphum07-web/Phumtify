...
type AdminTrack = { id: string; title: string; artist: string; created_at: string };
...
export default function AdminPage() {
  ...
  const loadTracks = () => { if (supabase) supabase.from('tracks').select('id,title,artist,created_at').order('created_at', { ascending: false }).then(({ data }) => setTracks(data ?? [])); };
