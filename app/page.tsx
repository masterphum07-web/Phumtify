  ...
  return <div className="app-shell">
    <aside className="sidebar">
      ...
      <nav className="nav-group">
        ...
        <Link className="nav-link" href="/library"><Library size={18} />คลังเพลง</Link><Link className="nav-link" href="/player"><Play size={18} />กำลังเล่น</Link>
      </nav>
