...
export default function Home() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      <div className="brand"><span className="brand-mark"><img src="/Phumtify/phumtify-logo.png" alt="" /></span><span>Phumtify</span></div>
